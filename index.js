...
var root = {
  // This gets a single restaurant based on a provided ID
  ...
  // This deletes a restaurant based on the provided id.
  deleterestaurant: ({ id }) => {
  ...
  // This updates a restaurant based on the provided id.
